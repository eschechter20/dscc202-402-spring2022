...
rf2_pyfunc_model = mlflow.pyfunc.load_model('runs:/bfd8721276bf4afc9177eb723a6c5e5d/random-forest-model-preprocess')
...
class RF_with_preprocess(mlflow.pyfunc.PythonModel):
    ...
    def preprocess_input(self, model_input):
        ...
        model_input = model_input.drop(['latitude', 'longitude', 'review_scores_accuracy', 'review_scores_cleanliness', 'review_scores_checkin', 'review_scores_communication', 'review_scores_location', 'review_scores_value'], axis=1)
        return model_input
...
class RF_with_postprocess(mlflow.pyfunc.PythonModel):
    ...
    def postprocess_result(self, results):
        ...
        ['Expensive' if  i > 100 else 'Not Expensive' for i in results]
        return 
